 ...
 * @author GeniSoft
 */
public class fenRechercherProduit extends JInternalFrame {
  ...
  //  private JComboBox cmbOption, cmbSexe, cmbVacation;
    private JButton btnrecommancer, btnAnnuler,btnrecher;
   ...
   private String path="..\\ProjetGestionUnasmoh\\src\\projetgestionunasmoh\\image\\";
    public fenRechercherProduit(String rech)
    {
   ...
   //creation des contraintes
        ...
        lblentete=new JLabel("Rechercher-Produit");
...
//        cmbSexe.addItem("Feminin");
      ...
      txtTypeprod.setEditable(false);
      txtQuantite.setEditable(false);
      txtPrix.setEditable(false);
      txtDate.setEditable(false);
        //creation des boutons
         btnrecommancer=new JButton("Recommencer");
         btnrecommancer.addActionListener(new ActionListener() {
            @Override
  ...
  lblCodeProduit.setVisible(false);
       ...
       btnrecommancer.setVisible(false);
         setSize(500, 200);
            }
        });
    ...
    pancomposant.add(txtrecher,gbc);
       ...
       btnrecommancer.setVisible(true);
             setSize(500, 360);
         ...
         JOptionPane.showMessageDialog(fenRechercherProduit.this, "code introuvable");
         }
